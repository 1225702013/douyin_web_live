...
from scripts import globalVar as gl
...
def go(url):
    ...
    with webdriver.Chrome(options=chrome_options,
        ...
        # print(json.loads(json_obj['initialState'])['roomStore'])
        ...
        # store.close()
        print("等待Wh+DxEZX")
        wait.until(presence_of_element_located((By.CLASS_NAME, "Wh+DxEZX")))
